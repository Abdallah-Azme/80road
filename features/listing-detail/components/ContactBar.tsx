...
export function ContactBar({ listingId, publisherId, isOwner }: Props) {
      ...
      >
        ...
        <div className="flex-1 flex gap-1">
          <Button
            id="contact-whatsapp"
            variant="outline"
            className="flex-1 gap-2 text-green-700 dark:text-green-400 border-green-200 dark:border-green-900 bg-green-50 dark:bg-green-950/20 hover:bg-green-100"
          ...
          {!isUnlocked && (
            <Button id="unlock-whatsapp" variant="outline" size="icon" onClick={() => setShowUnlock(true)}>
        ...
        <div className="flex-1 flex gap-1">
          ...
          {!isUnlocked && (
            <Button id="unlock-call" variant="outline" size="icon" onClick={() => setShowUnlock(true)}>
              <Lock className="w-4 h-4 opacity-60" />
            </Button>
          )}
        </div>
