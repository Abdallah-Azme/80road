...
export const metadata: Metadata = {
  ...
  description: 'إجابات على أكثر الأسئلة تكراراً حول استخدام منصة 80road العقارية.',
};
          ...
          {faqs.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 text-center gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-muted-foreground">نحن نعمل على جمع وإدراج الأسئلة الشائعة لمساعدتك بشكل أفضل.</p>
              </div>
            </div>
          )}
